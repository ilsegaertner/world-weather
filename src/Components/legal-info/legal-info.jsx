    ...
    <>
      <div className="p-48 bg-white md:px-24 lg:px-48 xl:px-64  xl:max-w-8xl ">
        ...
        <address className="py-4">
          World Weather App GmbH <br />
          Romanovskystr. 34 <br />
          10203 Berlin, Germany <br />
        </address>

        <p>
          E-Mail:
          <a href="mailto:info@worldweatherapp.com">info@worldweatherapp.com</a>
          <br />
          Internet address:
          <a href="https://www.worldweatherapp.com">www.worldweatherapp.com</a>
        </p>
        ...
        <p>
          This Privacy Policy describes how World-Weather-App ("we" or "us")
          collects, uses, and discloses personal information obtained through
          this website.
        </p>
        <p className="py-4">
          Information Collection and Use: We collect personal information, such
          as name and email address, through the contact form on this website.
          We use this information to respond to inquiries and provide requested
          services.
        </p>
        <p>
          Information Sharing: We do not share personal information with third
          parties unless required by law or with your consent.
        </p>

        <p className="py-4">
          Data Security: We take reasonable precautions to protect personal
          information from loss, misuse, or unauthorized access.
        </p>
        <p>
          Changes to this Privacy Policy: We may update this Privacy Policy from
          time to time. The updated version will be posted on this page.
        </p>

        <p className="py-4">
          Contact Us: If you have any questions about this Privacy Policy,
          please contact us at www.worldweatherapp.com.
        </p>
        ...
        <p className="py-4">
          ...
          images, graphics, and logos, is the property of
          www.worldweatherapp.com and is protected by copyright laws.
        </p>
        <p>
          Use of Content: You may not reproduce, modify, distribute, or
          republish any content from this website without prior written consent
          from www.worldweatherapp.com.
        </p>
        <p className="py-4">
          Disclaimer: The content on this website is provided "as is" without
          warranties of any kind. www.worldweatherapp.com shall not be liable
          for any errors or omissions in the content. Governing Law: These terms
          and conditions are governed by the laws of Germany.
        </p>
        <p>
          Contact Us: If you have any questions about these terms and
          conditions, please contact us at www.worldweatherapp.com.
        </p>
